...
*/
static struct ast_variable *realtime_curl(enum sql_select_modifier sql_select_modifier, const char *url, const char *unused, va_list ap)
{
 ...
 * \retval NULL on failure
*/
static struct ast_config *realtime_multi_curl(enum sql_select_modifier sql_select_modifier, const char *url, const char *unused, va_list ap)
{
	struct ast_str *query, *buffer;
	char buf1[256], buf2[256];
	const char *newparam, *newval;
